...
class ManagerNavigationTab {
  const ManagerNavigationTab({
    required this.label,
    required this.icon,
...
class ManagerBottomNavigationBar extends StatelessWidget {
  ...
  final List<ManagerNavigationTab> tabs;
...
class _ManagerTabButton extends StatelessWidget {
  const _ManagerTabButton({
    required this.tab,
  ...
  final ManagerNavigationTab tab;
    ...
    return Semantics(
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          duration: ManagerBottomNavigationBar._animationDuration,
