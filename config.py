...
IDENTITY_CORRECTIONS_PATH = 'output_videos/identity_corrections.json'
CORRECTED_TRACKING_JSON_PATH = 'output_videos/tracking_data_corrected.json'
IDENTITY_SUMMARY_REPORT_PATH = 'output_videos/identity_summary.json'
IDENTITY_EXPORT_STRICT_CONFLICTS = True
IDENTITY_UI_INITIAL_FRAMES = 10
